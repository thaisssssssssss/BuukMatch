...
public class LikeController {
    ...
    @PostMapping 
    public ResponseEntity<Void> registerLikeOnPost(@RequestBody LikeRequest request, @RequestHeader("Authorization") String token){
        likeService.registerLikeOnPost(request, token);
